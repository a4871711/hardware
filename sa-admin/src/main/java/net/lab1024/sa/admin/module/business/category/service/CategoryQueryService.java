...
public class CategoryQueryService {
     ...
     * @return 可能 null
     */
    public Optional<CategoryBaseEntity> queryCategory(Long categoryId) {
        if (null == categoryId) {
            return Optional.empty();
        }
        CategoryBaseEntity entity = categoryCacheManager.queryCategory(categoryId);
    ...
    public Map<Long, CategoryBaseEntity> queryCategoryList(List<Long> categoryIdList) {
        ...
        for (Long categoryId : categoryIdList) {
            CategoryBaseEntity categoryEntity = categoryCacheManager.queryCategory(categoryId);
