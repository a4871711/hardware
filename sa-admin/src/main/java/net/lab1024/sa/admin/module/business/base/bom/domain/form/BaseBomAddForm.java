...
@Data
public class BaseBomAddForm extends BaseBomEntity {
     ...
     * 产品材料
     */
    private List<BaseBomProductAddForm> bomProductList;

    /**
     * 其他费用
     */
    private List<BaseBomOtherAmountAddForm> bomOtherAmountList;
