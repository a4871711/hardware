...
public class PositionService {
    ...
    public ResponseDTO<String> add(PositionAddForm addForm) {
        PositionBaseEntity positionEntity = SmartBeanUtil.copy(addForm, PositionBaseEntity.class);
    ...
    public ResponseDTO<String> update(PositionUpdateForm updateForm) {
        PositionBaseEntity positionEntity = SmartBeanUtil.copy(updateForm, PositionBaseEntity.class);
