...
import net.lab1024.sa.admin.module.business.category.domain.entity.CategoryBaseEntity;
...
import net.lab1024.sa.admin.module.business.goods.domain.entity.GoodsBaseEntity;
...
public class GoodsService {
    ...
    public ResponseDTO<String> add(GoodsAddForm addForm) {
        ...
        GoodsBaseEntity goodsEntity = SmartBeanUtil.copy(addForm, GoodsBaseEntity.class);
    ...
    public ResponseDTO<String> update(GoodsUpdateForm updateForm) {
        ...
        GoodsBaseEntity originEntity = goodsDao.selectById(updateForm.getGoodsId());
        GoodsBaseEntity goodsEntity = SmartBeanUtil.copy(updateForm, GoodsBaseEntity.class);
    ...
    private ResponseDTO<String> checkGoods(GoodsAddForm addForm) {
        ...
        Optional<CategoryBaseEntity> optional = categoryQueryService.queryCategory(categoryId);
    ...
    public ResponseDTO<String> delete(Long goodsId) {
        GoodsBaseEntity goodsEntity = goodsDao.selectById(goodsId);
        if (goodsEntity == null) {
    ...
    public ResponseDTO<PageResult<GoodsVO>> query(GoodsQueryForm queryForm) {
        ...
        Map<Long, CategoryBaseEntity> categoryMap = categoryQueryService.queryCategoryList(categoryIdList);
        list.forEach(e -> {
    ...
    public List<GoodsExcelVO> getAllGoods() {
        List<GoodsBaseEntity> goodsEntityList = goodsDao.selectList(null);
