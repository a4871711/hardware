...
public class RoleEmployeeService {
    ...
    public ResponseDTO<PageResult<EmployeeVO>> queryEmployee(RoleEmployeeQueryForm roleEmployeeQueryForm) {
        ...
        if (CollectionUtils.isNotEmpty(departmentIdList)) {
            List<DepartmentBaseEntity> departmentEntities = departmentDao.selectBatchIds(departmentIdList);
            Map<Long, String> departmentIdNameMap = departmentEntities.stream().collect(Collectors.toMap(DepartmentBaseEntity::getDepartmentId, DepartmentBaseEntity::getName));
    ...
    public List<RoleSelectedVO> getRoleInfoListByEmployeeId(Long employeeId) {
        ...
        List<RoleBaseEntity> roleList = roleDao.selectList(null);
