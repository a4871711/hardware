...
public class RoleDataScopeService {
    ...
    public ResponseDTO<List<RoleDataScopeVO>> getRoleDataScopeList(Long roleId) {
        List<RoleDataScopeBaseEntity> roleDataScopeEntityList = roleDataScopeManager.getBaseMapper().listByRoleId(roleId);
    ...
    public ResponseDTO<String> updateRoleDataScopeList(RoleDataScopeUpdateForm roleDataScopeUpdateForm) {
        ...
        List<RoleDataScopeBaseEntity> roleDataScopeEntityList = SmartBeanUtil.copyList(batchSetList, RoleDataScopeBaseEntity.class);
