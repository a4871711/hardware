...
import net.lab1024.sa.base.common.annoation.IgnoreTenant;
...
@Mapper
@Component
public interface EmployeeDao extends BaseMapper<EmployeeBaseEntity> {
    /**
     * 查询员工列表
     */
     ...
     * 通过登录名查询
     */
    EmployeeBaseEntity getByLoginName(@Param("loginName") String loginName,
     ...
     * 通过姓名查询
     */
    EmployeeBaseEntity getByActualName(@Param("actualName") String actualName,
                                       @Param("disabledFlag") Boolean disabledFlag
    );
     ...
     * 通过手机号查询
     */
    EmployeeBaseEntity getByPhone(@Param("phone") String phone, @Param("disabledFlag") Boolean disabledFlag);
    ...
    @IgnoreTenant
    EmployeeBaseEntity selectById(@Param("employeeId") Long employeeId);


    /**
     * 获取某个部门的员工
     */
    List<EmployeeBaseEntity> selectByDepartmentId(@Param("departmentId") Long departmentId, @Param("disabledFlag") Boolean disabledFlag);


    /**
     * 查询某些部门下用户名是xxx的员工
     */
    List<EmployeeBaseEntity> selectByActualName(@Param("departmentIdList") List<Long> departmentIdList, @Param("actualName") String actualName, @Param("disabledFlag") Boolean disabledFlag);
