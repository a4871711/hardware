...
public class DepartmentService {
    ...
    public ResponseDTO<String> addDepartment(DepartmentAddForm departmentAddForm) {
        DepartmentBaseEntity departmentEntity = SmartBeanUtil.copy(departmentAddForm, DepartmentBaseEntity.class);
    ...
    public ResponseDTO<String> updateDepartment(DepartmentUpdateForm updateDTO) {
        ...
        DepartmentBaseEntity entity = departmentDao.selectById(updateDTO.getDepartmentId());
        if (entity == null) {
            return ResponseDTO.error(UserErrorCode.DATA_NOT_EXIST);
        }
        DepartmentBaseEntity departmentEntity = SmartBeanUtil.copy(updateDTO, DepartmentBaseEntity.class);
    ...
    public int insert(DepartmentBaseEntity entity) {
