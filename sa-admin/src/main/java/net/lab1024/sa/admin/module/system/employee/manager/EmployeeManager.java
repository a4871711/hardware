 ...
 */
@Service
public class EmployeeManager extends ServiceImpl<EmployeeDao, EmployeeBaseEntity> {
    ...
    public void saveEmployee(EmployeeBaseEntity employee, List<Long> roleIdList) {
        // 保存员工 获得id
     ...
     */
    @Transactional(rollbackFor = Throwable.class)
    public void updateEmployee(EmployeeBaseEntity employee, List<Long> roleIdList) {
        // 保存员工 获得id
