...
public class RoleService {
    ...
    public ResponseDTO<String> addRole(RoleAddForm roleAddForm) {
        RoleBaseEntity existRoleEntity = roleDao.getByRoleName(roleAddForm.getRoleName());
        ...
        RoleBaseEntity roleEntity = SmartBeanUtil.copy(roleAddForm, RoleBaseEntity.class);
    ...
    public ResponseDTO<String> updateRole(RoleUpdateForm roleUpdateForm) {
        ...
        RoleBaseEntity existRoleEntity = roleDao.getByRoleName(roleUpdateForm.getRoleName());
        ...
        RoleBaseEntity roleEntity = SmartBeanUtil.copy(roleUpdateForm, RoleBaseEntity.class);
     ...
     * 获取所有角色列表
     */
    public ResponseDTO<List<RoleVO>> getAllRole(String keywords) {
        List<RoleBaseEntity> roleEntityList = roleDao.selectListByKeywords(keywords);
        List<RoleVO> roleList = SmartBeanUtil.copyList(roleEntityList, RoleVO.class);
        return ResponseDTO.ok(roleList);
    }

    public int insertRoleMenu(RoleBaseEntity roleEntity) {
