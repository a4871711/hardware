...
public class SmartBeanUtil {
     ...
     * @return
     */
    public static <T, K> List<K> copyList(List<T> source, Class<K> target, String ...ignoreProperties) {
        if (null == source || source.isEmpty()) {
            return Collections.emptyList();
        }
        return source.stream().map(e -> copy(e, target,ignoreProperties)).collect(Collectors.toList());
    }
