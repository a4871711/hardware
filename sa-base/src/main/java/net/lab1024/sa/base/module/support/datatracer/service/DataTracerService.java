...
import net.lab1024.sa.base.module.support.datatracer.domain.entity.DataTracerBaseEntity;
...
public class DataTracerService {
    ...
    public void addTrace(DataTracerForm tracerForm, RequestUser requestUser) {
        DataTracerBaseEntity tracerEntity = SmartBeanUtil.copy(tracerForm, DataTracerBaseEntity.class);
    ...
    public void addTraceList(List<DataTracerForm> tracerFormList, RequestUser requestUser) {
        ...
        List<DataTracerBaseEntity> tracerEntityList = tracerFormList.stream().map(e -> {
            DataTracerBaseEntity tracerEntity = SmartBeanUtil.copy(e, DataTracerBaseEntity.class);
